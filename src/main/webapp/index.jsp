					...
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>The safety policy of a hospital is to provide a safe and healthy environment in which risks and hazards are eliminated for patients, visitors and employees. And also to minimize work-related injuries /illnesses through a programme of hazards reduction, elimination engineering controls, personal protective equipment training and regular environmental surveillance.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Wear appropriate PPE. See Table 5
...
Clean thoroughly, using neutral detergent and warm water solution.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Support patients and their loved ones when and where they are needed. Promote health as well as treat disease.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Postgraduates and faculty involved in research activities.All ethical and regulatory guidelines followed</p>
							</div>
						</div>
					</div>
				</div>
